package com.example.PM_Base_App.di.module;

import android.app.Application;
import androidx.annotation.NonNull;
import androidx.room.Room;

import com.example.PM_Base_App.data.local.AppDatabase;
...
public class DbModule {
    ...
    @Provides
    @Singleton
    ActionDao provideMovieDao(@NonNull AppDatabase appDatabase) {
